...
<div class="row">
    <div class="col-md-5">
        <img src="{{ $product->image_url }}" class="img-fluid rounded shadow-sm w-100" style="max-height: 380px; object-fit: cover;" alt="{{ $product->name }}">
    </div>
    <div class="col-md-7">
        ...
        @foreach($related as $item)
            <div class="col">
                <div class="card h-100 shadow-sm border-0">
                    <img src="{{ $item->image_url }}" class="card-img-top rounded-top" alt="{{ $item->name }}" style="height: 150px; object-fit: cover;">
                    <div class="card-body">
